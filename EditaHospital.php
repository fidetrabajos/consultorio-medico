...
$id = $_POST['id']; 
	...
	"select nombre , telefono , ubicacion from t_hospital where id_hospital = '$id'";
  ...
  <p>&nbsp;</p>
   <p>&nbsp;</p>
    <table border='0'> 
        ...
        <form method='POST' action='EditarHospital2.php'> 
        <tr> 
            <td width='50%'>&nbsp;</td> 
            <td width='50%'>&nbsp;</td> 
        </tr> 
        <tr> 
            <td width='50%'><p ><b><h4>Nombre del centro medico: </h4></b></td> 
        ...
        <tr> 
		 ...
		 <tr> 
            ...
            <td width='50%'><p ><input type='text' name='ubicacion' size='20' value='".$registro['ubicacion']."'></td> 
        </tr> 
