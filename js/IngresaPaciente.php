      ...
      <a class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="http://www.bootply.com/render/62603#">Sobre el centro</a></li>
            <li><a href="ConsultaEspecialidad.php" target="ext">Nuestras especialidades</a></li>
            <li><a href="ConsultaHospital.php">Instalaciones</a></li>
...
<form role="form" id="form" name="form" method="post" action="Config/agregarMedico.php">
