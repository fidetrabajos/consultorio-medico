...
$id = $_POST['id']; 
	...
	"select m.id_medico,m.nombre,m.apellido1,m.apellido2,m.telefono,m.direccion from t_medico m , t_especialidad e , t_hospital h where m.t_especialidad_id_especialidad=e.id_especialidad and m.t_hospital_id_hospital = h.id_hospital and m.id_medico = '$id'";
  ...
  <p>&nbsp;</p>
   <p>&nbsp;</p>
    <table border='0'> 
        ...
        <form method='POST' action='EditarMedico2.php'> 
        <tr> 
            <td width='50%'>&nbsp;</td> 
            <td width='50%'>&nbsp;</td> 
        </tr> 
        <tr> 
            <td width='50%'><p ><b><h4>Nombre del Medico: </h4></b></td> 
		...
		<td width='50%'><p ><b><h4>Ubicacion</h4></b></td> 
...
?> 
  ...
  <center><a href="inicio.php"> <button type="submit" class="btn btn-default">Volver</a></button></center>
</div>
</div>
</div>
