...
$id = $_POST['id']; 
	...
	"select nombre , descripcion from t_especialidad where id_especialidad = '$id'";
  ...
  <p>&nbsp;</p>
   <p>&nbsp;</p>
    <table border='0'> 
        ...
        <form method='POST' action='EditarEspecialidad2.php'> 
        <tr> 
            <td width='50%'>&nbsp;</td> 
            <td width='50%'>&nbsp;</td> 
        </tr> 
        <tr> 
            <td width='50%'><p ><b><h4>Nombre de la especialidad: </h4></b></td> 
            <td width='50%'><p ><input type='text' name='nombre' size='20' value='".$registro['nombre']."'></td> 
        </tr> 
        <tr> 
            <td width='50%'><p ><b><h4>Descripcion</h4></b></td> 
            <td width='50%'><p ><input type='text' name='descripcion' size='20' value='".$registro['descripcion']."'></td> 
        </tr> 
